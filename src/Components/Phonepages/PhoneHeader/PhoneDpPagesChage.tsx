...
import styles from "../PhoneModuleCSS/PhoneDpPagesChange.module.css";


export const PhoneDpPagesChange = () => {
  ...
  return (
    <div className={styles.tag}>
      <div className={styles.spandiv}>
            ...
            <div>
             <span className={`${styles.span7} ${isActive === 7? styles.active : ""}`} onClick={() =>handleActive(7)}>その他</span>
            </div> 
            {/* <div>
