...
import styles from "./GachaanimeCSS/Gachaanime10.module.css"
import anime from "animejs"
import {useNavigate } from 'react-router-dom'


export const Gachaanime100 = () => {
        ...
        missText1?.classList.add(styles.misstextAnimation)
          ...
          setTimeout(() => {
             ...
             setTimeout(()=> {
              ...
              bigHitText1?.classList.add(styles.bighittextAnimation)
                setTimeout(() => {
                 bigHitText2?.classList.add(styles.bighittextAnimation)
                },500)
              
                setTimeout(()=> {
                  bigHitText3?.classList.add(styles.bighittextAnimation)
                },1000)
                setTimeout(()=> {
                  bigHitText4?.classList.add(styles.bighittextAnimation)
                },1500)

                setTimeout(()=> {
                  bigHitText1?.classList.remove(styles.bighittextAnimation)
                },4000)

                setTimeout(()=> {
                  bigHitText2?.classList.remove(styles.bighittextAnimation)
                },5000)

                setTimeout(()=> {
                  bigHitText3?.classList.remove(styles.bighittextAnimation)
                },6000)

                setTimeout(()=> {
                  bigHitText4?.classList.remove(styles.bighittextAnimation)
                },7000)
            }}
  ...
  return (
      <div className={styles.div}>
       <div className={styles.wrapper} ref={WrapperRef}>
          ...
          <p className={styles.bighittext} id='bighitText1'>大</p>
          <p className={styles.bighittext} id='bighitText2'>当</p>
          <p className={styles.bighittext} id='bighitText3'>た</p>
          <p className={styles.bighittext} id='bighitText4'>り</p>
       </div>
    </div> 
  )
}
